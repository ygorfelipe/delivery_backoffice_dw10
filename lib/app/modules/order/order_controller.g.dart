...
mixin _$OrderController on OrderControllerBase, Store {
  ...
  late final _$chanceStatusAsyncAction =
      AsyncAction('OrderControllerBase.chanceStatus', context: context);

  @override
  Future<void> chanceStatus(OrderStatus status) {
    return _$chanceStatusAsyncAction.run(() => super.chanceStatus(status));
  }

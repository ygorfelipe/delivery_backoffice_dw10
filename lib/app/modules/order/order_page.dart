...
class _OrderPageState extends State<OrderPage> with Loader, Messages {
      ...
      statusDisposer = reaction((_) => controller.status, (status) {
        switch (status) {
          ...
          case OrderStateStatus.error:
            hideLoader();
            showErro(controller.errorMessage ?? 'Erro interno');
            break;
          case OrderStateStatus.showDetailModal:
            hideLoader();
            showOrderDetail();
            break;
          case OrderStateStatus.statusChanched:
            hideLoader();

            //! fechando a modal da forma correta
            Navigator.of(context, rootNavigator: true).pop();
            //* chamando a order novamente
  ...
  //! aqui é a onde nos iremos fazer o modal

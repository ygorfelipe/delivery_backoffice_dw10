...
//!                 SEMPRE ESSA ESTRUTURA! NAO ESQUECER!
//* _________________________________________________________________________________________________________
//! sempre no construturo, colocar with Loader, Messages para fazer a extensão dos mixis
class _ProductsPageState extends State<ProductsPage> with Loader, Messages {
  ...
  //* ele esta sendo chamado aqui na view, para ele não ter a necessidade de ser chamado na controller
  //* sendo assim, mais facil para a manutenção e para não haver a chamada no back-end
  final debouncer = Debouncer(milliseconds: 500);

//! sempre devemos fazer esse padrão
  @override
  void initState() {
      ...
      statusDisposer = reaction((_) => controller.status, (status) async {
        switch (status) {
          ...
          case ProductStateStatus.error:
            hideLoader();
            showErro('Erro ao buscar produtos');
            break;
          case ProductStateStatus.addOrUpdateProduct:
            hideLoader();
            //* aqui nos iremos fazer uma verificação para ver se é para inserir ou alterar

    ...
    return Card(
      ...
      child: LayoutBuilder(builder: (_, contraints) {
        return Column(
          ...
          children: [
            //* esse container aqui, vai ser baseado no tamanho em que você esta, ou seja
            //* precisa ter a responsitividade, então não pode ser fixo
            Container(
            ...
            Padding(
              ...
              //* tooltip é quando passa o cursor do mouse em cima ele mostra o nome completo
              child: Tooltip(
